resource "aws_cloudfront_distribution" "learndevopswithprakash" {
  enabled             = true
...
resource "aws_route53_record" "cdn" {
    ...
    type = "A"
          ...
          alias {
            name                   = aws_cloudfront_distribution.learndevopswithprakash.domain_name
            zone_id                = aws_cloudfront_distribution.learndevopswithprakash.hosted_zone_id
